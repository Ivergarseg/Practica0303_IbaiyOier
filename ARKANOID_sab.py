...
while True:
    ...
    if coor_b_y > 485:  #GAME OVER
     ...
     # Choque entre la bola y los ladrillos
    for ladrillo in ladrillos:
        if (
            coor_b_y + 15 == ladrillo.dist_y   # Ajustar según sea necesario
            and coor_b_y + 15 == ladrillo.dist_x
            and ladrillo.dist_x < coor_b_x < ladrillo.dist_x + ladrillo.dist_l
        ):
